...
const filePath = "plugins/dist/msdk-single-core-uart-loop-back/.cfsplugin";
...
describe("MSDK Single Core UART Loop Back Tests", () => {
    ...
    Object.entries(supportedSocs).forEach(([soc, boards]) => {
      boards.forEach((board) => {
        it(`For ${soc} soc with ${board} board`, async () => {
          ...
          cfsWorkspace = {
            location:
              "tests/unit-tests/plugins/msdk-single-core-uart-loop-back/data",
