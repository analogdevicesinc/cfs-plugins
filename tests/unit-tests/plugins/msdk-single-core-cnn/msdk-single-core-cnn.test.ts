...
const filePath = "plugins/dist/msdk-single-core-cnn/.cfsplugin";
...
describe("MSDK Single Core CNN Tests", () => {
  ...
  describe("GenerateWorkspace_BasicFlow_ShouldGenerateExpectedFiles", () => {
    const expectedWorkspaceFilesBase = [
      ...
      "m4/.vscode/flash.gdb",
      "m4/README.md",
      "m4/src/adi_cnn/cnn.c",
      "m4/src/adi_cnn/cnn.h",
      "m4/src/adi_cnn/sampledata.h",
      "m4/src/adi_cnn/sampleoutput.h",
      "m4/src/adi_cnn/weights.h",
      "m4/src/adi_cnn/softmax.c",
      "m4/ai85-catsdogs-qat8-q.pth.tar",
      "m4/cats-dogs-hwc-no-fifo.yaml",
    ...
    Object.entries(supportedSocs).forEach(([soc, boards]) => {
      boards.forEach((board) => {
        it(`For ${soc} soc with ${board} board`, async () => {
          ...
          cfsWorkspace = {
            location: "tests/unit-tests/plugins/msdk-single-core-cnn/data",
