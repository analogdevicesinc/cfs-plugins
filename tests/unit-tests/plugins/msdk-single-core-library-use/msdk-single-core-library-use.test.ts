...
const filePath = "plugins/dist/msdk-single-core-library-use/.cfsplugin";
...
describe("MSDK Single Core Library Use Tests", () => {
    ...
    Object.entries(supportedSocs).forEach(([soc, boards]) => {
      boards.forEach((board) => {
        it(`For ${soc} soc with ${board} board`, async () => {
          ...
          cfsWorkspace = {
            location:
              "tests/unit-tests/plugins/msdk-single-core-library-use/data",
