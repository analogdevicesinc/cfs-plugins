...
const filePath = "plugins/dist/msdk-single-core-tflm/.cfsplugin";
...
describe("MSDK Single Core TFLM Tests", () => {
  ...
  describe("GenerateWorkspace_BasicFlow_ShouldGenerateExpectedFiles", () => {
    const expectedWorkspaceFilesBase = [
      ...
      "m4/.vscode/flash.gdb",
      "m4/hello_world_f32.tflite",
      "m4/README.md",
      "m4/src/adi_tflm/adi_tflm.hpp",
      "m4/src/adi_tflm/hello_world_model_f32.cpp",
      "m4/src/adi_tflm/hello_world_model_f32.hpp",
      "m4/src/main.cpp",
    ...
    Object.entries(supportedSocs).forEach(([soc, boards]) => {
      boards.forEach((board) => {
        it(`For ${soc} soc with ${board} board`, async () => {
          ...
          cfsWorkspace = {
            location: "tests/unit-tests/plugins/msdk-single-core-tflm/data",
