...
const filePath = "plugins/dist/sharcfx-multi-core-example/.cfsplugin";
...
describe("SHARC-FX Multi-Core Hello World Tests", () => {
    ...
    Object.entries(supportedSocs).forEach(([soc, boards]) => {
      boards.forEach((board) => {
        it(`Using ${soc} SoC with ${board} board`, async () => {
          ...
          cfsWorkspace = {
            location:
              "tests/unit-tests/plugins/sharcfx-multi-core-example/data",
