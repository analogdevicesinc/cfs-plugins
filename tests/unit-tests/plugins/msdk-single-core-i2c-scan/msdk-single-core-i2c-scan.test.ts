...
const filePath = "plugins/dist/msdk-single-core-i2c-scan/.cfsplugin";
...
describe("MSDK Single Core I2C Scan Tests", () => {
    ...
    Object.entries(supportedSocs).forEach(([soc, boards]) => {
      boards.forEach((board) => {
        it(`For ${soc} soc with ${board} board`, async () => {
          ...
          cfsWorkspace = {
            location:
              "tests/unit-tests/plugins/msdk-single-core-i2c-scan/data",
