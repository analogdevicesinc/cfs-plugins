...
-   Connect a USB cable between the PC and the CN1 (USB/PWR) connector.
-   Open a terminal application on the PC and connect to the FTHR console UART/USB-UART interface at 115200, 8-N-1.
-   Connect J8.8 (P1.0) to J8.15 (P2.7).

## Expected Output

### For MAX78000EVKIT: The Console UART of the device will output these messages:

```
**************** UART Example ******************
This example sends data from one UART to another.

Connect the TX pin of UART2 to the RX pin of UART1 for this example.
...
### For MAX78000FTHR: The Console UART of the device will output these messages:
