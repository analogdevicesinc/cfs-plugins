...
if (it.cfsconfig.Package.toUpperCase() === "CTBGA") {
  ...
  peripheralData = [
    { datamodel: "ADC", enable: "ENABLE", zephyr: "adc", clocknode: "ADC",
      pins: [
    ...
    { datamodel: "DMA", enable: "ENABLE", zephyr: "dma0", clocknode: "DMA"},
    { datamodel: "I2C0", enable: "I2C0_ENABLE", zephyr: "i2c0", clocknode: "I2C0/1/2",
      pins: [
    ...
    { datamodel: "I2C1", enable: "I2C1_ENABLE", zephyr: "i2c1", clocknode: "I2C0/1/2",
      pins: [
    ...
    { datamodel: "I2C2", enable: "I2C2_ENABLE", zephyr: "i2c2", clocknode: "I2C0/1/2",
      pins: [
    ...
    { datamodel: "LPTMR0", enable: "ENABLE", zephyr: "lptimer0", clocknode: "LPTMR0", clock_mux : "MUX", clock_default : "IBRO",
      pins: [
          { signal: "CLK", pin: "C6", name: "lptmr0_clk_p2_6"},
    ...
    { datamodel: "LPTMR1", enable: "ENABLE", zephyr: "lptimer1", clocknode: "LPTMR1", clock_mux : "MUX", clock_default : "IBRO",
      pins: [
          { signal: "CLK", pin: "D6", name: "lptmr1_clk_p2_7"},
    ...
    { datamodel: "LPUART0", enable: "ENABLE", zephyr: "uart3", clocknode: "LPUART0",
      pins: [
    ...
    { datamodel: "OWM", enable: "ENABLE", zephyr: "w1", clocknode: "OWM",
      pins: [
    ...
    { datamodel: "SPI0", enable: "ENABLE", zephyr: "spi0", clocknode: "SPI0",
      pins: [
    ...
    { datamodel: "SPI1", enable: "ENABLE", zephyr: "spi1", clocknode: "SPI1",
      pins: [
    ...
    { datamodel: "TMR0", enable: "TMR0_ENABLE", zephyr: "timer0", clocknode: "TMR0/1/2/3", clock_mux : "TMR0a_MUX", clock_default : "PCLK",
      pins: [
    ...
    { datamodel: "TMR1", enable: "TMR1_ENABLE", zephyr: "timer1", clocknode: "TMR0/1/2/3", clock_mux : "TMR1a_MUX", clock_default : "PCLK",
      pins: [
    ...
    { datamodel: "TMR2", enable: "TMR2_ENABLE", zephyr: "timer2", clocknode: "TMR0/1/2/3", clock_mux : "TMR2a_MUX", clock_default : "PCLK",
      pins: [
    ...
    { datamodel: "TMR3", enable: "TMR3_ENABLE", zephyr: "timer3", clocknode: "TMR0/1/2/3", clock_mux : "TMR3a_MUX", clock_default : "PCLK",
      pins: [
    ...
    { datamodel: "TRNG", enable: "TRNG_ENABLE", zephyr: "trng", clocknode: "AES/CRC/TRNG"},
    { datamodel: "UART0", enable: "UART0_ENABLE", zephyr: "uart0", clocknode: "UART0/1/2", clock_mux: "UART0_MUX", clock_default: "PCLK",
      pins: [
    ...
    { datamodel: "UART1", enable: "UART1_ENABLE", zephyr: "uart1", clocknode: "UART0/1/2", clock_mux: "UART1_MUX", clock_default: "PCLK",
      pins: [
    ...
    { datamodel: "UART2", enable: "UART2_ENABLE", zephyr: "uart2", clocknode: "UART0/1/2", clock_mux: "UART2_MUX", clock_default: "PCLK",
      pins: [
    ...
    { datamodel: "WDT0", enable: "ENABLE", zephyr: "wdt0", clocknode: "WDT0", clock_mux: "MUX", clock_default: "PCLK"},
    { datamodel: "LPWDT0", enable: "ENABLE", zephyr: "wdt1", clocknode: "LPWDT0", clock_mux: "MUX", clock_default: "IBRO"}
  ];
  ...
  peripheralData = [
    ...
    { datamodel: "DMA", enable: "ENABLE", zephyr: "dma0", clocknode: "DMA"},
    { datamodel: "I2C0", enable: "I2C0_ENABLE", zephyr: "i2c0", clocknode: "I2C0",
      pins: [
    ...
    { datamodel: "LPTMR0", enable: "ENABLE", zephyr: "lptimer0", clocknode: "LPTMR0", clock_mux : "MUX", clock_default : "IBRO",
      pins: [
          { signal: "CLK", pin: "C8", name: "lptmr0_clk_p2_6"}
      ],
      subnode: () => getAssignedPeripheral("LPTMR0").Config?.MODE_A === "COMPARE" ? "counter" : "pwm",
      pins_node: () => getAssignedPeripheral("LPTMR0").Config?.MODE_A === "COMPARE" ? undefined : "subnode",
      config: [
    ...
    { datamodel: "LPTMR1", enable: "ENABLE", zephyr: "lptimer1", clocknode: "LPTMR1", clock_mux : "MUX", clock_default : "IBRO",
      pins: [
          { signal: "CLK", pin: "D5", name: "lptmr1_clk_p2_7"}
      ],
      subnode: () => getAssignedPeripheral("LPTMR1").Config?.MODE_A === "COMPARE" ? "counter" : "pwm",
      pins_node: () => getAssignedPeripheral("LPTMR1").Config?.MODE_A === "COMPARE" ? undefined : "subnode",
      config: [
    ...
    { datamodel: "TRNG", enable: "TRNG_ENABLE", zephyr: "trng", clocknode: "AES/CRC/TRNG"},
    { datamodel: "UART0", enable: "UART0_ENABLE", zephyr: "uart0", clocknode: "UART0", clock_mux: "UART0_MUX", clock_default: "PCLK",
      pins: [
...
unsupported_in_dts = [
    {datamodel: ["ADC"], clocknode: "ADC", diag: "Setting the ADC clock divider is not currently supported in devicetree.", ctrl: "DIV"},
    {datamodel: [], clocknode: "ERFO Mux", diag: "Bypass of the ERFO is not currently supported in devicetree.", ctrl: "ERFO Mux", value: "ERFO_CLK"},
    {datamodel: [], clocknode: "ERTCO Mux", diag: "Bypass of the ERTCO is not currently supported in devicetree.", ctrl: "ERTCO Mux", value: "ERTCO_CLK"},
    ...
    {datamodel: ["AESKEYS"], clocknode: "AES", diag: "The AES peripheral is not currently supported in devicetree.", ctrl: "ENABLE", value: "TRUE"},
    ...
    {datamodel: ["CRC"], clocknode: "CRC", diag: "The CRC peripheral is not currently supported in devicetree.", ctrl: "ENABLE", value: "TRUE"},
    {datamodel: ["I2S"], clocknode: "I2S", diag: "The I2S peripheral is not currently supported in devicetree.", ctrl: "ENABLE", value: "TRUE"},
    ...
    {datamodel: ["SEMA"], clocknode: "SEMA", diag: "The SEMA peripheral is not currently supported in devicetree.", ctrl: "ENABLE", value: "TRUE"}
];
