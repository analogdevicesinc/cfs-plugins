...
For more information, visit the [CoreMark webpage](https://www.eembc.org/coremark/) and look through the [COREMARK_README](./COREMARK_README.md).
...
* This project comes pre-configured for the board selected when generating the workspace.
