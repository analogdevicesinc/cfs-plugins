...
This example uses the I2C Controller to find the addresses of any I2C Target devices connected to the same bus as I2C2 on the MAX32655EVKIT and I2C1 on the MAX32655FTHR.
