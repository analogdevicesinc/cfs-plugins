...
This example uses the I2C Controller to find the addresses of any I2C Target devices connected to the same bus as I2C1 (MAX78000FTHR) or I2C2 (MAX78000EVKIT).
...
-   Open a terminal application on the PC and connect to the board console UART at 115200, 8-N-1.
