 ...
 * @details     This example uses the I2C Controller to find addresses of the I2C Target devices
...
#define I2C_CONTROLLER MXC_I2C2 // SCL P0_30; SDA P0_31
#define I2C_SCL_PIN 30
#define I2C_SDA_PIN 31
#else
#define I2C_CONTROLLER MXC_I2C1 // SCL P0_16; SDA P0_17
