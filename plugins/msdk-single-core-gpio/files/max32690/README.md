...
The Console UART of the device will output these messages (pin numbers may be different depending on which board the example is built for):
...
Connect P4.0->P2.11 to use SW2 to trigger a falling edge interrupt on each press.
```
