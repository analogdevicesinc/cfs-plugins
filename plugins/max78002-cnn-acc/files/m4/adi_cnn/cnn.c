...
int cnn_configure(void)
{
  ...
  *((volatile uint32_t *) 0x5110064c) = 0x080e5000; // Post processing register
  ...
  *((volatile uint32_t *) 0x5210064c) = 0x080e4000; // Post processing register
  ...
  *((volatile uint32_t *) 0x5310064c) = 0x080e4000; // Post processing register
  ...
  *((volatile uint32_t *) 0x5410064c) = 0x080e4000; // Post processing register
