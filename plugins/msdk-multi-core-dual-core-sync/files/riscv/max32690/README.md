...
This version of riscv prints an incrementing count to the console UART and toggles the LED0 every 500 ms.
...
README file of project `m4` will present more details on the dual core synchronization.
...
* **This project is not typically compiled on its own**.  Instead, the `m4` project should be used to build and load it.
